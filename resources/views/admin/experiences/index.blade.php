...
<body>
    ...
    <div class="content">
        ...
        <!-- Dropdown Filter -->
    <form method="GET" action="{{ route('experiences.index') }}" class="form-inline">
                ...
                @foreach ($experiences as $experience)
                    <tr>
                        ...
                        @if ($filter === 'with-trash')
                            ...
                            <form action="{{ route('experiences.restore', $experience->id) }}" method="POST" style="display: inline-block;">
                                @csrf
                                @method('POST')
                                <button type="submit" class="btn btn-success btn-sm">Restore</button>
                            </form>
                            <form action="{{ route('experiences.force-delete', $experience->id) }}" method="POST" style="display: inline-block;">
                                @csrf
                                @method('DELETE')
