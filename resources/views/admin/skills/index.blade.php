...
<body>
    ...
    <div class="content">
        ...
        <!-- Dropdown Filter -->
    <form method="GET" action="{{ route('skills.index') }}" class="form-inline">
                ...
                @foreach ($skills as $skill)
                    <tr>
                        ...
                        @if ($filter === 'with-trash')
                            ...
                            <form action="{{ route('skills.restore', $skill->id) }}" method="POST" style="display: inline-block;">
                                @csrf
                                @method('POST')
                                <button type="submit" class="btn btn-success btn-sm">Restore</button>
                            </form>
                            <form action="{{ route('skills.force-delete', $skill->id) }}" method="POST" style="display: inline-block;">
                                @csrf
                                @method('DELETE')
