    ...
    <div class="content">
        ...
        <form action="{{ route('projects.update', $project->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" id="category" name="category" value="{{ old('category', $project->category) }}" required>
            </div>
            ...
            <div class="form-group">
                ...
                <img src="{{ asset('storage/' . $project->image) }}" alt="{{ $project->title }}" style="width: 100px; margin-top: 10px;">
            </div>
            <div>
        ...
        <a href="{{ route('projects.index') }}" class="back-link">Back to Projects List</a>
    </div>
</body>
</html>
